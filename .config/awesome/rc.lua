...
config_dir = ("/home/sogimu/.config/awesome/")
...
browser = "chromium"
pythonWebServer = terminal .. " -e python -m http.server 8000"
sublimeText = "/home/sogimu/sublime_text_3/sublime_text"
...
tags = {
  names  = { "terminals", "www", "IM", 4, 5, 6, 7, 8, 9},
  layout = { layouts[4], layouts[10], layouts[10], layouts[4], layouts[1], layouts[6], layouts[6], layouts[5], layouts[6]
}}
...
system_menu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.awesome_icon },
...
mainMenuLauncher = awful.widget.launcher({ image = beautiful.awesome_icon, menu = system_menu })
...
-- tdwidget = awful.widget.textclock()
...
calendar2.addCalendarToWidget(tdwidget, "<span color='green'>%s</span>")
...
vicious.register( batwidget, vicious.widgets.bat, '<span background="#92B0A0" font="Inconsolata 11"><span font="Inconsolata 11" color="#FFFFFF" background="#92B0A0">$1$2% </span></span>', 
5, "BAT0" )


--{{---| File Size widget |-----
-- fswidget = blingbling.net.new()--value_text_box.new()--wibox.widget.textbox()
--fswidget:set_ippopup()
 -- fswidget:set_show_text(true)
 -- fswidget:set_v_margin(3)
...
'<span background="#4B3B51" font="Inconsolata 11"><span font="Inconsolata 11" color="#EEEEEE"> Vol:$1 </span></span>', 
0.3, "Master")
...
'<span background="#4B696D" font="Inconsolata 11"> <span font="Inconsolata 11" color="#DDDDDD">$2%<span color="#888888">·</span>$3% </span></span>'
, 1)
...
vicious.register(memwidget, vicious.widgets.mem, '<span background="#777E76" font="Inconsolata 11"> <span font="Inconsolata 11" color="#EEEEEE" background="#777E76">$2MB </span></span>'
, 10)
...
for s = 1, screen.count() do
    ...
    right_layout:add(mainMenuLauncher)
...
-- run_once("redshift -l 55.030063999999996:82.91994199999999")
